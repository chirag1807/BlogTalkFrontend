...
import '../../providers/CreateBlogProvider.dart';
...
class _EditBlogScreenState extends State<EditBlogScreen> {
  ...
  void initState() {
    ...
    editTitleCtrl.text = widget.blog.title ?? "";
    editContentCtrl.text = widget.blog.content ?? "";
  }
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: text("Edit Blog", 20, FontWeight.w700, themeColorWhite, TextDecoration.none, TextAlign.center),
                      ...
                      builder: (context, provider, child){
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            ...
                            Image.network(widget.blog.coverImage ?? "") :
                            Column(
                    ...
                    Consumer<CreateBlogProvider>(
                        builder: (context, provider, child){
                          if(provider.circularBarShow == 1){
                            Future.microtask(() => provider.getAllTopicNameIds(widget.blog.topic ?? -1));
                          }
          ...
          bottomNavigationBar: Container(
            ...
            child: ClipRRect(
              ...
              child: Consumer<CreateBlogProvider>(
                  builder: (context, provider, child){
                    if(provider.successUploadPost == 1){
                      print("fromSuccessUploadPost1");
                      WidgetsBinding.instance.addPostFrameCallback((_) {
                        ScaffoldMessenger.of(context).showSnackBar(displaySnackBar("Post Updated Successfully", themeColorSnackBarGreen));
                      });
                    ...
                    return InkWell(
                      onTap: (){
                        provider.uploadPost(widget.blog.sId ?? "", editTitleCtrl.text, editContentCtrl.text, blogTopicValue, coverImg, 1);
                      },
                      child: Container(
                        width: w,
                        alignment: Alignment.center,
