class FollowingsModel {
  ...
  FollowingsModel({this.followingUid, this.isFollowingBack, this.user});

  FollowingsModel.fromJson(Map<String, dynamic> json) {
    followingUid = json['followingUid'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['followingUid'] = followingUid;
    data['isFollowingBack'] = isFollowingBack;
    if (user != null) {
